                ...
                <ul class="pull-right list-inline">
                    <li>
                        <a href="tel:012.345.1234">
                            <i class="icon-telephone"></i>012.345.1234</a>
                    </li>
                    <li>
                        <a href="mailto:info@company.com">
                            <i class="icon-envelope"></i>info@company.com</a>
                    </li>
                </ul>
            </div>
            <!-- End of .contact-info -->
        ...
        <nav id="navbar-main" class="navbar main-menu">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('index') }}">
                    <img src="{{ asset('assets/images/logo.png') }}" width="200px" alt="Brand" class="img-responsive" />
                </a>
            </div>
            ...
            <div id="rev_slider_1078_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    ...
                    @foreach($banners as $key => $banner)
                        <li data-index="rs-{{ $key }}" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{ $banner->image }}" alt="{{ $banner->h1 }}" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone"
                            ...
                            <div class="visible-xs caption-mobile">
                                <div class="h1" style="color: #008ccb;">{{ $banner->h1 }}</div>
                                <div class="h2" style="color: #323a45;">{{ $banner->h2 }}</div>
                            </div>
                            <!-- LAYER NR. 1 -->
                            ...
                            <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-2" id="slide-3046-layer-15" data-x="left" data-hoffset="0"
                                ...
                                <a class="dmb-home medium-btn2 btn btn-nofill page-scroll" href="#">Портфолио</a>
                            </div>
                        </li>
                    @endforeach
                </ul>
...
<div class="clients">
    ...
    <div class="container">
        <div class="clients-logos owl-carousel owl-theme">
            <div class="item">
                <img src="{{ asset('assets/images/client1.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client2.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client3.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client4.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client5.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client6.png') }}" alt="partners logo" class="img-responsive">
            </div>
            <!-- End of .item -->
            <div class="item">
                <img src="{{ asset('assets/images/client1.png') }}" alt="partners logo" class="img-responsive">
...
<section class="bg-white o-hidden services dms-modern" id="services">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="box-green-border">
                    <a href="services.html#bm-online-marketing">
        ...
        <div class="grid clearfix row">
            ...
            <div class="a2 a1 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-one.jpg') }} alt="port_img" class="img-responsive">
                    <div class="overlay">
            ...
            <div class="a3 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-two.jpg') }} alt="port_img" class="img-responsive">
            ...
            <div class="a2 a1 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-three.jpg') }} alt="port_img" class="img-responsive">
                    <div class="overlay">
            ...
            <div class="a3 a4 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-four.jpg') }} alt="port_img" class="img-responsive">
                    <div class="overlay">
            ...
            <div class="a2 a1 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-five.jpg') }} alt="port_img" class="img-responsive">
                    <div class="overlay">
            ...
            <div class="a3 a4 a1 grid-item">
                <div class="img_container">
                    <img src={{ asset('assets/images/portfolio/portfolio-six.jpg') }} alt="port_img" class="img-responsive">
                    <div class="overlay">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-xs-12 pull-right floating-img">
                                <img src={{ asset('assets/images/browser-screen.png') }} alt="browser-screen" class="img-responsive pull-right">
                            </div>
                        </div>
                        <!-- End of .row -->
                    </div>
                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-xs-12 pull-right floating-img">
                                <img src={{ asset('assets/images/browser-screen2.png') }} alt="browser-screen" class="img-responsive pull-right">
                            </div>
                        </div>
                        <!-- End of .row -->
                    </div>
                ...
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-xs-12 pull-right floating-img">
                                <img src={{ asset('assets/images/browser-screen3.png') }} alt="browser-screen" class="img-responsive pull-right">
                            </div>
                        </div>
                        <!-- End of .row -->
                    </div>
    ...
    <div class="container">
        ...
        <div class="row grid">
            <div class="col-sm-6 col-md-4 grid-item">
                <div class="content text-left">
                    <div class="img-container">
                        <img src={{ asset('assets/images/google-logo.png') }} class="img-responsive" alt="google logo">
                    </div>
            ...
            <div class="col-sm-6 col-md-4 grid-item">
                <div class="content text-left">
                    <div class="img-container">
                        <img src={{ asset('assets/images/facebook-logo.png') }} class="img-responsive" alt="facebook logo">
                    </div>
                    <div class="clients-rating">
            ...
            <div class="col-sm-6 col-md-4 grid-item">
                <div class="content text-left">
                    <div class="img-container">
                        <img src={{ asset('assets/images/yelp-logo.png') }} class="img-responsive" alt="yelp logo">
                    </div>
                    <div class="clients-rating">
                        <div class="clients-rating-top" style="width: 85%;">
                            <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="blog-content is-featured">
                    <img src={{ asset('assets/images/news1.jpg') }} alt="blog" class="img-responsive blog-img" />
            ...
            <div class="col-sm-6 col-md-4">
                <div class="blog-content">
                    <img src={{ asset('assets/images/news2.jpg') }} alt="blog" class="img-responsive blog-img" />
                    <div class="box-green-border equalheight">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="blog-content">
                    <img src={{ asset('assets/images/news3.jpg') }} alt="blog" class="img-responsive blog-img" />
                    <div class="box-green-border equalheight">
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="index.html">
                                <img src={{ asset('assets/images/small-logo.png') }} alt="logo" class="img-responsive logo">
                            </a>
                        </li>
                        <li>
                                ...
                                <div id="myCarousel" class="carousel slide myCarousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="active item" data-slide-number="0">
                                            <img src={{ asset('assets/images/portfolio/portfolio-details-slider-one.jpg') }} alt="images" class="img-responsive">
                                        </div>
                                        <div class="item" data-slide-number="1">
                                            <img src={{ asset('assets/images/portfolio/portfolio-details-slider-two.jpg') }} alt="images" class="img-responsive">
                                        </div>
                                        <div class="item" data-slide-number="2">
                                            <img src={{ asset('assets/images/portfolio/portfolio-details-slider-three.jpg') }} alt="images" class="img-responsive">
                                        </div>
                                            ...
                                            <ul class="list-inline  thumb-list">
                                                <li>
                                                    <a id="carousel-selector-0" class="carousel-selector selected">
                                                        <img src={{ asset('assets/images/portfolio/portfolio-slider-thum-1.jpg') }} class="img-responsive"
                                                             alt=""> </a>
                                                </li>
                                                <li>
                                                    <a id="carousel-selector-1" class="carousel-selector">
                                                        <img src={{ asset('assets/images/portfolio/portfolio-slider-thum-2.jpg') }} class="img-responsive"
                                                             alt=""> </a>
                                                </li>
                                                <li>
                                                    <a id="carousel-selector-2" class="carousel-selector">
                                                        <img src={{ asset('assets/images/portfolio/portfolio-slider-thum-3.jpg') }} class="img-responsive"
                                                             alt=""> </a>
                                                </li>
                                            </ul>
                                        </div>
...
<script type="text/javascript" src="{{ asset('assets/js/isotope.min.js') }}">
</script>
